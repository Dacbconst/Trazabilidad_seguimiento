...
<head>
    ...
    <style>
        ...
        .swal2-warning {
            border-color: #81e5f4ff !important;
            /* Color celeste para el borde */
            color: #0bd5f4ff !important;
            /* Color celeste para el signo de exclamación */
        }

        /* Estilo para hacer las esquinas del botón de confirmación más redondas */
        .rounded-confirm-button {
            border-radius: 25px !important;

        }

        /* Estilo para cambiar el color de la "X" del botón de cierre a rojo */
        .swal2-close {
        ...
        .btn-secondary1 {
            ...
            margin-top: 0.5rem;
            border-radius: 80px;
            /* Ejemplo: 8px para un redondeado suave */
        ...
        .mi-boton-flotante {
            ...
            /* Suaviza la transición para la animación */
            position: relative;
            /* Necesario para que el z-index y la sombra funcionen bien */
            z-index: 1;
        }
        ...
        .mi-boton-flotante:hover {
            ...
            box-shadow: 0 4px 50px rgba(255, 0, 0, 0.2);
            /* La sombra que solicitaste */
            z-index: 2;
            /* Asegura que el botón "flote" por encima de todo lo demás */
        }
    ...
    <div class="content-container">
        <div class="row text-center text-md-start align-items-center mb-4">
            <div class="col-12 col-md-6 mb-3 mb-md-0 d-flex justify-content-center justify-content-md-start">
                <img src="assets/images/alicorp.jpg" alt="Logo ALICORP"
                    class="img-fluid rounded" style="max-width: 180px;">
            </div>

            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-end">
                <button class="btn d-flex flex-column align-items-center p-2 mi-boton-flotante" id="btnPreciosAlicorp">
                    <img src="assets/images/precios.jpg" alt="Precios Alicorp"
                        style="width: 80px; height: 80px; object-fit: cover;">
                    <p class="fw-bold mb-2">Precios Alicorp</p>
                </button>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div id="ciudadElegidaContainer" class="col-md-3 my-4 mt-3 mb-3 d-none">
                                <strong>Ciudad elegida:</strong> <span id="ciudadElegidaTexto"></span>
                            </div>


                            <div class="mt-3 mb-3">
                                <label for="puntoVenta" class="form-label"><strong>Seleccione la ciudad</strong></label>
                        ...
                        <div id="preguntasNuevas-container" class="mt-2">
                            <form id="formulario-preguntasNuevas" method="post">
                            </form>
                        </div>


                        <!-- Textarea de Comentario agregado aquí -->
                        <div id="container-comentario" class="m-3" style="display: none;">
                            <label for="comentarioTextarea" class="form-label"><strong>Comentario:</strong></label>
                            <textarea class="form-control" id="txtComentario" rows="3" placeholder="Escriba su comentario aquí..."></textarea>
                        </div>
